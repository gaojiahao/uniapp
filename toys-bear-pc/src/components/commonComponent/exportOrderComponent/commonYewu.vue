      ...
      <div class="tp1" v-show="tp === 1">
        ...
        <div class="imgBox">
          <el-image
            ...
            class="myImg"
            :z-index="5000"
            :preview-src-list="[require('@/assets/images/commonYewu1.jpg')]"
            :src="require('@/assets/images/commonYewu1.jpg')"
          ></el-image>
        </div>
      ...
      <div class="tp1" v-show="tp === 2">
        ...
        <div class="imgBox">
          <el-image
            fit="contain"
            :z-index="5000"
            :preview-src-list="[require('@/assets/images/commonYewu2.jpg')]"
            class="myImg"
            :src="require('@/assets/images/commonYewu2.jpg')"
          ></el-image>
        </div>
        <div class="selectTions">
          <div class="label">
      ...
      <div class="tp1" v-show="tp === 3">
        ...
        <div class="imgBox">
          <el-image
            fit="contain"
            :z-index="5000"
            :preview-src-list="[require('@/assets/images/commonYewu3.jpg')]"
            class="myImg"
            :src="require('@/assets/images/commonYewu3.jpg')"
          ></el-image>
        </div>
        <div class="selectTions">
          <div class="label">
      ...
      <div class="tp1" v-show="tp === 4">
        ...
        <div class="imgBox">
          <el-image
            fit="contain"
            :z-index="5000"
            :preview-src-list="[require('@/assets/images/commonYewu4.jpg')]"
            class="myImg"
            :src="require('@/assets/images/commonYewu4.jpg')"
          ></el-image>
        </div>
        <div class="selectTions">
          <div class="label">
      ...
      <div class="tp1" v-show="tp === 5">
        ...
        <div class="imgBox">
          <el-image
            ...
            class="myImg"
            :z-index="5000"
            :preview-src-list="[require('@/assets/images/commonYewu5.jpg')]"
            :src="require('@/assets/images/commonYewu5.jpg')"
          ></el-image>
        </div>
        <div class="selectTions">
          <div class="label">
      ...
      <div class="tp1" v-show="tp === 6">
        ...
        <div class="imgBox">
          <el-image
            fit="contain"
            :z-index="5000"
            :preview-src-list="[require('@/assets/images/commonYewu6.jpg')]"
            class="myImg"
            :src="require('@/assets/images/commonYewu6.jpg')"
          ></el-image>
        </div>
        <div class="selectTions">
          <div class="label">
