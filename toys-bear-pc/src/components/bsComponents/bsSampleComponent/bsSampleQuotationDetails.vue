  ...
  <div class="bsSampleQuotationDetails">
    ...
    <div class="hander">
      <div class="handerTop">
        <div class="flex_t">
          <p>
            报价单号：<span class="pId">{{ item.offerNumber }} </span>
          </p>
          <p>
            客户名称：<span>{{ item.customerName }} </span>
          </p>
          <p>
            操作员：<span style="color:#2D7FE4">{{ item.linkman }} </span>
          </p>
          <p>
            状态：<span
              :style="{
                color: item.status == 0 ? '#3368A9' : '#2D7FE4'
              }"
              >{{
                item.status == 0
                  ? "未审核"
      ...
      <div class="handerTab">
        <el-table
          ...
          lazy
        >
          <el-table-column prop="date" label="默认公式" width="180">
          </el-table-column>
          <el-table-column prop="name" label="报价方式" width="180">
          </el-table-column>
          <el-table-column prop="address" label="利润率"> </el-table-column>
          <el-table-column prop="name" label="总费用" width="180">
          </el-table-column>
          <el-table-column prop="name" label="汇率" width="180">
          </el-table-column>
          <el-table-column prop="address" label="小数位数"> </el-table-column>

          <el-table-column prop="address" label="币种"> </el-table-column>
          <el-table-column prop="address" label="每车尺寸"> </el-table-column>
          <el-table-column prop="address" label="取舍方式"> </el-table-column>
          <el-table-column prop="address" label="价钱小于"> </el-table-column>
          <el-table-column prop="address" label="小数位数"> </el-table-column>
        </el-table>
      </div>
    </div>
