    ...
    <ul class="customerInfoBox">
      ...
      <div class="clientContentBox">
        <div class="left">
          <li class="clientItem">
            <span>客户：</span>
            <span class="content">{{ orderOption.customerName }}</span>
          </li>
          <li class="clientItem">
            <span>择样时间：</span>
            <span class="content">
              {{
                orderOption.createdOn && orderOption.createdOn.replace(/T/, " ")
              }}
            </span>
          </li>
        </div>
        <div class="middle">
          <li class="clientItem">
            <span>联系人：</span>
            <span class="content">{{ orderOption.contactName }}</span>
          </li>
          <li class="clientItem">
            <span>公司名称：</span>
            <span class="content">{{ orderOption.companyName }}</span>
          </li>
        </div>
        <div class="right">
          <li class="clientItem">
            <span>邮箱：</span>
            <span class="content">{{ orderOption.email }}</span>
          </li>
          <li class="clientItem">
            <span>备注：</span>
            <span class="content">{{ orderOption.remark }}</span>
          </li>
        </div>
      </div>
    </ul>
