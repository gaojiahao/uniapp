  ...
  <div class="offerDetailBox">
    ...
    <div class="Graphic">
      ...
      <div class="cententText" v-if="productDetail">
          ...
          <p class="textItem" v-show="productInfo && productInfo.productOfferType !== 'company'">出厂价：<span class="price" v-if="$_.isNumber(productDetail.unitPrice)">{{'￥' + productDetail.unitPrice.toFixed((productDetail.decimalPlaces || 2))}}</span></p>
