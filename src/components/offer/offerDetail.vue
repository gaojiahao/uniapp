   ...
   <div class="topLayout">
    ...
    <div class="centent"  v-if="productDetail">
      ...
      <div class="cententText">
        ...
        <p class="textItem" v-show="productInfo && productInfo.productOfferType !== 'company'">出厂价：<span class="price" v-if="$_.isNumber(productDetail.unitPrice)">{{ '￥' + (productDetail.unitPrice && productDetail.unitPrice) }}</span></p>
