...
export default {
  ...
  methods: {
    ...
    // 获取订单详情
    async getOrderDetail ({ orderType, erpOrderID, orderNumber, sampleNumber, messageExt }) {
  ...
  async mounted () {
    ...
    this.$nextTick(() => this.$root.eventHub.$emit('resetGetERPOrderListByPage'))
  }
}
</script>
