<template>
  <el-container>
    ...
    <!-- 新增编辑客户dialog -->
    <el-dialog :title="dialogTitle" :visible.sync="addClienDialog" destroy-on-close width="50%">
      <el-form
      ...
      >
        ...
        <el-form-item label="备注" prop="remark">
          <el-input type="textarea" placeholder="请输入备注信息" :rows="4" resize="none" v-model="clienFormData.remark"></el-input>
        </el-form-item>
        <center>
          <template>
