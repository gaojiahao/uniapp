  ...
  .right {
    ...
    .infoItem {
      ...
      .iconBox {
        ...
        height: 18px;
        &.telephoneIcon {
          background: url("~@/assets//images/telephoneIcon.png") no-repeat
            center;
        }
        &.QQIcon {
          background: url("~@/assets//images/QQIcon.png") no-repeat center;
        }
        &.lingdangIcon {
          background: url("~@/assets//images/lingdangIcon.png") no-repeat center;
        }
      }
      .userIcon {
        width: 30px;
