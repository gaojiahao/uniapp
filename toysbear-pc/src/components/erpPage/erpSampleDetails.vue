  ...
  <div class="tableBox">
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <el-image style="width: 57px; height: 47px;" :preview-src-list="scope.row.imgUrl" :src="scope.row.imgUrl && scope.row.imgUrl[0]">
          <div slot="error" class="image-slot">
            <img style="width: 57px; height: 47px; borderRadius: 50%;" src="~@/assets/images/logo.png" alt />
          </div>
        </el-image>
      </template>
    </el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getOrderDetail () {
      const res = await this.$http.post('/api/SampleOrderDetailPage', { maxResultCount: this.pageSize, skipCount: this.currentPage, id: this.option.erpOrderID, sampleNumber: this.option.orderNumber })
