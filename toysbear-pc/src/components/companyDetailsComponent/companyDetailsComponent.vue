      ...
      <div class="detailBox" v-if="CompanyDetail">
        ...
        <div class="ContactInformation">
          ...
          <div class="ContactItem">
            ...
            <div class="text">
              <template  v-if="CompanyDetail.orgCompany && CompanyDetail.orgCompany.address">
      ...
      <el-form label-position="left" label-width="80px">
        <el-form-item label="标签内容">
          <el-input
            ...
            autocomplete="off"
            :maxlength="
              globalJson.Json.CompanyRestrictions && globalJson.Json.CompanyRestrictions[0].itemCode
            "
          ></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    async getCompanyDetails () {
      const res = await this.$http.post('/api/OrgCompanyLableListByID', { CompanyId: this.options.companyId })
      if (res.data.result.code === 200) this.CompanyDetail = res.data.result.item
