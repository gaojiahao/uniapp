    ...
    <div class="filterTitle">
      <div class="left">
        ...
        <div class="filterProduct">
          ...
          <p :class="{'filterItem': true, 'isActive': isScreen === 1}" @click="sortScreen">筛选<i v-show="isScreen === 0" class="el-icon-d-caret"></i><i class="el-icon-caret-bottom" v-show="isScreen === 1"></i></p>
        ...
        <div class="screens transition-box" v-show="isScreen === 1">
          <div class="contentWrap">
            ...
            <div class="right">
              ...
              <el-select v-model="packingDatetime" @change="getDateList" placeholder="全部">
                <el-option
