<template>
  <div class="baojia">
    <div class="productBox">
      <el-carousel autoplay class="myImg" ref="swiperRef">
        <el-carousel-item v-for="(item, i) in 4" :key="i">
          <div class="myImgBox" @touchstart="touchStart"
            @touchmove="touchMove"
            @touchend="touchEnd">
            <el-image
              :z-index="9999999"
    ...
    <div class="priceBox">
      <div class="price">
        <span class="priceItem">￥20 </span>现货：0pcs
      </div>
    ...
    <div class="contentText">
      ...
      <div class="conText">
        ...
        <div class="item"><div class="title">出厂货号：</div>HS0046642</div>
        <div class="item"><div class="title">包装：</div>PVC卡头袋</div>
        <div class="item"><div class="title">装箱量：</div>内盒数/装箱数(PCS)</div>
        <div class="item"><div class="title">样品规格：</div>29×3×22(CM)</div>
        <div class="item"><div class="title">包装规格：</div>10×20×30(CM)</div>
        <div class="item"><div class="title">外箱规格：</div>29×3×22(CM)</div>
        <div class="item"><div class="title">体积/材积：</div>0.035/10.27</div>
        <div class="item"><div class="title">毛重/净重：</div>30.02/20.01(KG)</div>
        <div class="item"><div class="title">证书编号：</div>1234567890123456</div>
      </div>
    </div>
  </div>
</template>
