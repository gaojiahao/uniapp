<template>
  ...
  <!-- @scroll="baojiaScroll"
    ...
    <div class="searchBox">
      <div class="keyWordSearch">
        <el-input v-model="keyword" clearable @keyup.enter.native="search" placeholder="请输入搜索关键字">
  ...
  <div class="productBox" v-if="!isList">
    <div class="item"  @click.stop="toProductDetail(item)" v-for="(item, i) in 10" :key="i">
      <div class="myImgBox">
        <el-image
        class="myImg"
  ...
  <div class="productListBox" v-else>
    <div class="itemBox" @click.stop="toProductDetail(item)" v-for="(item, i) in 5" :key="i">
      <div class="top">
        <div class="left">
          <el-image
            class="myImg"
        ...
        <div class="right">
          ...
          <p class="item">外箱规格：<span class="value">86*53.5*73(CM)</span></p>
          <p class="item">体积/材积：<span class="value">0.336(CBM)/ 11.85(CUFT)</span></p>
          <p class="item">毛重/净重：<span class="value">9.6/11.6(KG)</span></p>
